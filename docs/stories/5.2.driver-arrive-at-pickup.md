...
**Note:** Extended TripStatus value (ARRIVED_AT_PICKUP) was officially adopted into architecture v4.1 on November 1, 2025 following implementation validation in Epic 5.
